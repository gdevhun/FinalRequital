...
AFRTA_MonsterTrace::AFRTA_MonsterTrace()
{
	PrimaryActorTick.bCanEverTick = false;
}

void AFRTA_MonsterTrace::StartTargeting(UGameplayAbility* Ability)
{
...
void AFRTA_MonsterTrace::ConfirmTargetingAndContinue()
{
	if (SourceActor)
	{
...
FGameplayAbilityTargetDataHandle AFRTA_MonsterTrace::MakeTargetData() const
{
